...
class PlanetsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set header
        view.findViewById<TextView>(R.id.header_title).text = "🪐 Sayyoralar"
        view.findViewById<TextView>(R.id.header_subtitle).text = "Quyosh sistemasidagi sayyoralar"
